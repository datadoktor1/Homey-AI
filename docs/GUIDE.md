# Programming Homey from Cursor (or any IDE)

This guide shows how to control an [Athom Homey](https://homey.app) smart-home hub
from your computer using an IDE such as [Cursor](https://cursor.com), VS Code, or
PyCharm. You write automation logic as **HomeyScript** (JavaScript that runs on the
